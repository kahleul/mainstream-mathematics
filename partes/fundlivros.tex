...
\begin{defi}
    Diremos que duas expressões são \textit{compatíveis} se uma delas puder ser obtida adicionando alguma expressão (possivelmente a expressão vazia) ao final da outra.
\end{defi}
