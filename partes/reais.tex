...
\begin{defi}
    Seja $\emptyset \neq A \subseteq \F$ um subconjunto de um corpo ordenado $\F$.
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            \item Diremos que $A$ é
                \begin{enumerate}[label=\roman*.]
                    \item \textit{limitado superiormente}, ou \textit{majorado}, se existir $a \in \F$ tal que $x \leq a$ para todo $x \in A$. Diremos que $a$ é uma \textit{cota superior}, ou um \textit{majorante}, de $A$.
...
\begin{prop}
    Seja $\emptyset \neq A \subseteq \F$ um subconjunto de um corpo ordenado $\F$.
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            \item O supremo de $A$, quando existe, é único.
            \item O ínfimo de $A$, quando existe, é único.
        \end{enumerate}
\end{prop}
...
\begin{teo}
    Existe um corpo ordenado completo. Diremos que seus elementos são \textit{números reais} e o denotaremos por $\R$.
\end{teo}

\begin{cor}
    Todo subconjunto não vazio de $\R$ limitado inferiormente admite ínfimo em $\R$.
\end{cor}
...
\begin{prop}
    \leavevmode
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            \item Para quaisquer $m,n \in \N$, temos $m+n \in \N$ e $m \cdot n \in \N$.
            \item Para qualquer $n \in \N$, temos $n \geq 1$. Isso significa, em particular, que $\N$ é limitado inferiormente.
...
\begin{proof}
    \leavevmode
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            ...
            \item Definindo $A := \{ n \in \N : n \geq 1\}$, temos $A \subseteq \N$. Claramente $1 \in A$ pois $1 \geq 1$. Agora, se $n \in A$, então $1>0 \Rightarrow n+1 > n \geq 1 \Rightarrow n+1 \geq 1$, de modo que $n+1 \in A$. Com isso, $A$ é indutivo e, portanto, cumpre $\N \subseteq A$, donde $A = \N$. \itemproof
            \item Suponha que $\N$ seja limitado superiormente. Como $\N \subsetneq \R$, existe $a := \sup{\N}$. Como $a-1$ não é cota superior de $\N$, existe $n \in \N$ tal que $a-1 < n$. Mas, daí, $a < n+1 \in \N$, absurdo! Em particular, concluímos que para todo $x \in \R$ existe $n \in \N$ tal que $n > x$. \itemproof
...
\begin{lem}
    \leavevmode
        \begin{enumerate}[leftmargin=*, align=left, label=\textbf{(\alph*)}]
            ...
            \item Para qualquer $n \in \N$, não existe um $m \in \N$ para o qual $n < m < n+1$.
        \end{enumerate}
\end{lem}
